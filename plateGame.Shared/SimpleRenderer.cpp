...
void SimpleRenderer::Draw(float& omega)
{
    ...
    MathHelper::Matrix4 modelMatrix = MathHelper::SimpleModelMatrix((float)mDrawCount * omega);
...
void SimpleRenderer::sendTextureToOpenGL()
{
	...
	//unsigned char* image = SOIL_load_image("../plateGame.Android.Application/res/tiles3.jpg", &width, &height, 0, SOIL_LOAD_RGBA);
